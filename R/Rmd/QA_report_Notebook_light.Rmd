...
The table below summarizes the data available per operation. Some of this data is still being quality assured and uploaded into the COMPASS system.
...
```{r eval=FALSE, fig.height=3, fig.width=6.5, message=FALSE, warning=FALSE, include=FALSE}
...
```{r eval=FALSE, fig.height=4, fig.width=6.5, message=FALSE, warning=FALSE, include=FALSE}
...
```{r eval=FALSE, fig.height=6, fig.width=6.5, message=FALSE, warning=FALSE, include=FALSE}
...
```{r eval=FALSE, fig.height=7, fig.width=6.5, message=FALSE, warning=FALSE, include=FALSE}
